        ...
        <>
            ...
            <main>
                ...
                <ProjectContent ref={contentBoxRef}>
                    <ProjectHero
                        title="Designing Scalable Multi-Signature Transaction Flows for Institutional Crypto Wallets"
                        description="An exploratory case study that adapts a single initiation flow across Ethereum and Solana while addressing multi-sig wallet needs."
                    ...
                    <ProjectSection id="objectives">
                        ...
                        <div className={`${projectStyles.projectCardGroup} ${projectStyles.projectCardGroup3} ${projectStyles.projectCardGroupWithText}`}>
                            <div className={projectStyles.projectCard}>
                                <div className={projectStyles.projectCardIcon}>#1</div>
                            ...
                            <div className={projectStyles.projectCard}>
                                <div className={projectStyles.projectCardIcon}>#2</div>
                            ...
                            <div className={projectStyles.projectCard}>
                                <div className={projectStyles.projectCardIcon}>#3</div>
                    ...
                    <ProjectSection id="user-flow">
                        ...
                        <img src="/assets/projects/multisig-transaction-flow/user-flow-light.png" alt="Transaction initiation user flow diagram" className={projectStyles.projectImage} />
                    </ProjectSection>

                    <ProjectSection id="form-design">
                        {/* Form Design Decisions */}
                        <h2>Form Design Decisions</h2>

                        <h3>Modal Placement</h3>
                        <img src="/assets/projects/multisig-transaction-flow/modal-placement.jpg" alt="Modal placement design decisions" className={projectStyles.projectImage} />

                        <h3>Blank State</h3>
                        <img src="/assets/projects/multisig-transaction-flow/blank-state.jpg" alt="Blank state design" className={projectStyles.projectImage} />

                        <h3>Form Validations</h3>
                        <img src="/assets/projects/multisig-transaction-flow/form-validations.jpg" alt="Form validation patterns" className={projectStyles.projectImage} />

                        <h3>Chain-Specific Fields and Behaviors</h3>
                        <img src="/assets/projects/multisig-transaction-flow/chain-specific.jpg" alt="Chain-specific fields and behaviors" className={projectStyles.projectImage} />

                        <h3>Confirmation Actions</h3>
                        <img src="/assets/projects/multisig-transaction-flow/confirmation-actions.jpg" alt="Confirmation action states" className={projectStyles.projectImage} />

                        <h3>Confirmation</h3>
                        <img src="/assets/projects/multisig-transaction-flow/confirmation.jpg" alt="Transaction confirmation screen" className={projectStyles.projectImage} />

                        <h3>Failed State</h3>
                        <img src="/assets/projects/multisig-transaction-flow/failed.jpg" alt="Failed transaction state" className={projectStyles.projectImage} />
                    </ProjectSection>
